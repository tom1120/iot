...
$(function () {
    ...
    $('#changeToAutoDiagram').click(function() {
        ...
        $('#processDiagram').attr('src', 'service/traceProcessController/trace/data/auto/' + processInstanceId);
    });

});

function showActivities() {
    $.getJSON('service/traceProcessController/trace/data/' + executionId, function (infos) {
