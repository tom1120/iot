...
<html>
 ...
 <body style="overflow-x: hidden;">
	...
	<fieldset style="border: 1px solid #E6E6E6;">
		...
		<textarea type="textarea" style="margin-top: 20px;border: 1px inset #E6E6E6;width: 95%;height:300px;word-wrap:break-word;word-break:break-all;resize:none" id="viewData" class="formdbdiv"></textarea>
	</fieldset>
 </body>