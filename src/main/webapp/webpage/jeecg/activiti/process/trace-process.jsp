...
<head>
    ...
    <script type="text/javascript" src="plug-in/activiti/trace-process.js"></script>
...
<div class="easyui-layout" fit="true">
    <%-- 先读取图片再通过Javascript定位 --%>
     <div region="center" style="padding: 1px;">
        <img id="processDiagram" src="service/activitiController/read-resource?pdid=${historicProcessInstance.processDefinitionId}&resourceName=${processDefinition.diagramResourceName}" />
    </div>
