...
function createDataGrid${config_id}(){
	...
	function ${config_id}add(){
		...
		var url ='cgFormBuildController.do?goAddFtlForm&tableName=${config_id}&olstylecode=${_olstylecode}';
	...
	function ${config_id}update(){
		...
		var url ='cgFormBuildController.do?goUpdateFtlForm&tableName=${config_id}&olstylecode=${_olstylecode}';
