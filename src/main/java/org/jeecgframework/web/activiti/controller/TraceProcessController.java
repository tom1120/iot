 ...
 * Created by zhaoyipc on 2017/6/12.
 */
...
import org.jeecgframework.web.activiti.util.ActivityUtil;
 ...
 * 流程跟踪控制器
 * @author zhaoyi
 * @date 2017-06-2017/6/12-17:06
 */
@Controller
@RequestMapping("/traceProcessController")
public class TraceProcessController {
    ...
    public ModelAndView historyDatas(@PathVariable("executionId") String executionId) {
        ModelAndView mav = new ModelAndView("jeecg/activiti/process/trace-process");
