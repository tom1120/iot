...
public class DynamicTask162 {
	
	private static Logger logger = Logger.getLogger(DynamicTask162.class);
...
/**
	...
	public synchronized static void updateSpringMvcTaskXML(CronTrigger trigger, String cronExpression) {
		...
		try {
			URI url = DynamicTask162.class.getClassLoader().getResource("spring-mvc-timeTask.xml").toURI();
